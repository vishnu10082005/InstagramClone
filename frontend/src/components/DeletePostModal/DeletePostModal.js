...
const DeletePost = ({onClose,onConfirm}) => {
    return (
        <Modal
            isOpen={true}
        ...
        >
            <div className="bg-white rounded-lg p-4 md:p-6 lg:p-8 w-full max-w-md mx-4 relative">
                ...
                <h2 className="text-xl font-semibold mb-4" >Delete Post Confirmation</h2>
                <p className="mb-4">Are you want to delete Post ?</p>
                <div className="flex justify-end space-x-4">
                    <button className="bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600" onClick={onConfirm}>Yes</button>
